...
if save:
    ...
    np.save(current_path + '/data/sim/eps_rewards_a2c' + date_time, tot_rewards)
    np.save(current_path + '/data/sim/particle_end_a2c' + date_time, particle_arr)
    np.save(current_path + '/data/sim/time_end_a2c' + date_time, time_arr)
