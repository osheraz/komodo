...
r = np.load(current_path + '/data/sim/eps_rewardsddpg.npy')
# r2 = np.load(current_path + '/data/sim/eps_rewards.npy')

p = np.load(current_path + '/data/sim/particle_endddpg.npy')
t = np.load(current_path + '/data/sim/time_endddpg.npy')
# p =p[:800]
# r = np.where(r>0,r,0)
# t = t[:800] * 8 / 20
# t = np.where(t<1, 8,t)
