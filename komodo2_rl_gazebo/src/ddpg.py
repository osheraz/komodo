...
class A2C:
    ...
    def __init__(self, state_shape, action_shape, actor_lr=0.001, critic_lr=0.001, gamma=0.99,use_layer_norm=True):
        ...
        self.actor_and_critic = self.critic_net(self.input_state,self.actor,name='critic',reuse=True,use_layer_norm=self.use_layer_norm) # Critic with actor action as input
    ...
    def set_model_loss(self, critic, actor_and_critic, actor_target, actor_and_critic_target, rewards, dones, gamma):
        ...
        ======
            ...
            actor_and_critic -> Q_expected_actor with actor output action { input: actor action , Output: Q }
            actor_and_critic_target -> Q_target_next { input: action_next , Output: Q_next }
        """

        # Compute Q targets for current states (y_i)
        # actor_and_critic_target - Get predicted next-state actions and Q values from target models
